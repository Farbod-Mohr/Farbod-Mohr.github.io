        ...
        if (entry.isIntersecting) {
            ...
            //The "stat" section needed extra stuff other than just fading-in normally.
                ...
                if (pass == false) {
                    ...
                    MyStatInterval(document.querySelector("#about-stats-num-1"), 127, 20, 1)
                    MyStatInterval(document.querySelector("#about-stats-num-2"), 1505, 14, 7)
                    MyStatInterval(document.querySelector("#about-stats-num-3"), 109, 30, 1)
                    MyStatInterval(document.querySelector("#about-stats-num-4"), 102, 31, 1)
                    MyStatInterval(document.querySelector("#about-stats-num-5"), 127, 20, 1)
                    MyStatInterval(document.querySelector("#about-stats-num-6"), 1505, 14, 7)
                    MyStatInterval(document.querySelector("#about-stats-num-7"), 109, 30, 1)
                    MyStatInterval(document.querySelector("#about-stats-num-8"), 102, 31, 1)
